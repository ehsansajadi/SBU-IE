...
const Keypad = ({
	...
	return (
		<>
		<div>
			<Key text={"MS"} red onClick={onMemorySave} />
			<Key text={"M+"} red onClick={onMemoryPlus} />
			<Key text={"M-"} red onClick={onMemorySubtract} />
			<Key text={"MR"} red onClick={onMemoryRecall} />
			<Key text={"MC"} red onClick={onMemoryClear} />
